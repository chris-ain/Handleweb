...
window.addEventListener("load", () => {
  ...
  const planeElements = document.getElementsByClassName("plane_arbeiten_detail");
...
plane && plane.onLoading(function () {
  ...
  void main() {
      ...
      vec2 redTextCoords = vec2(vTextureCoord.x, vTextureCoord.y - uScrollEffect / 40000000000000000.0);
      vec2 greenTextCoords = vec2(vTextureCoord.x, vTextureCoord.y - uScrollEffect / 300000000000000000.0);
      vec2 blueTextCoords = vec2(vTextureCoord.x, vTextureCoord.y - uScrollEffect / 300000000000000000.0);
